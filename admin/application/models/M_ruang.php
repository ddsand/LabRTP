...
class M_ruang extends CI_Model {
	var $table = 'tblruang'; //deklarasi tabel yang digunakan
	var $column_order = array('namaruang','ketua'); //deklarasi nama kolom untuk digunakan pada fungsi order/sort  
	var $column_search = array('namaruang','ketua'); //deklarasi nama kolom untuk query search
	var $order = array('idruang' => 'asc'); //deklarasi  id tabel untuk fungsi search and order
