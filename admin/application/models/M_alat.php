...
class M_alat extends CI_Model {
	var $table = 'tblalat'; //deklarasi tabel yang digunakan
	var $column_order = array('namaalat','tahun','jumlah','status'); //deklarasi nama kolom untuk digunakan pada fungsi order/sort  
	var $column_search = array('namaalat','tahun','jumlah','status'); //deklarasi nama kolom untuk query search
	var $order = array('idalat' => 'asc'); //deklarasi  id tabel untuk fungsi search and order
	...
	public function countAll($table){
		$this->db->select('count(idalat) as rows');
		$this->db->from($table);
