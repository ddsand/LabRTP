...
class M_artikel extends CI_Model {
	var $table = 'tblartikel'; //deklarasi tabel yang digunakan
	var $column_order = array('judulartikel','tglrilis'); //deklarasi nama kolom untuk digunakan pada fungsi order/sort  
	var $column_search = array('judulartikel','tglrilis'); //deklarasi nama kolom untuk query search
	var $order = array('idartikel' => 'asc'); //deklarasi  id tabel untuk fungsi search and order
	...
	public function countAll($table){
		$this->db->select('count(idartikel) as rows');
		$this->db->from($table);
