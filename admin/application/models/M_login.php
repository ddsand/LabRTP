...
class M_login extends CI_Model {
	var $table = 'tbluser'; //deklarasi tabel yang digunakan
	var $column_order = array('user','password'); //deklarasi nama kolom untuk digunakan pada fungsi order/sort  
	var $column_search = array('user','password'); //deklarasi nama kolom untuk query search
	var $order = array('iduser' => 'asc'); //deklarasi  id tabel untuk fungsi search and order
	...
	//fungsi untuk cek username dan password login website
	public function cek_login($where) {
		$res = $this->db->get_where($this->table,$where);
		return $res;
	}
	...
	public function countAll($table){
		$this->db->select('count(iduser) as rows');
		$this->db->from($table);
