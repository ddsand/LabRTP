...
class M_peminjaman extends CI_Model {
	var $table = 'tblpinjamalat'; //deklarasi tabel yang digunakan
	var $column_order = array('namaalat','jumlah','tglpinjam','kelas','status','peminjam','tglkembali','status'); //deklarasi nama kolom untuk digunakan pada fungsi order/sort  
	var $column_search = array('namaalat','jumlah','tglpinjam','kelas','status','peminjam','tglkembali','status'); //deklarasi nama kolom untuk query search
	...
	private function _get_datatables_query()
	{
		...
		$this->db->join('tblalat','tblalat.idalat=tblpinjamalat.idalat','inner');
