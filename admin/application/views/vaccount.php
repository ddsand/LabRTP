...
<script type="text/javascript">
    ...
    $(document).ready(function(){
       table = $('#tabel').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('Login/account_list')?>",
                "type": "POST"
            },
    ...
    function tambah_data() //menambah data ke database
     {
        ...
        $('.modal-title').text('Tambah Data User'); //digunakan untuk mengatur judul pada modal bootstrap
    }
    ...
    function hapus_data(id) //fungsi untuk menghapus data dari database
    {
        ...
        {
            $.ajax({
                url : "<?php echo site_url('Login/account_delete')?>/"+id, //mendefinisikan fungsi pada controller untuk aksi delete
    ...
    function edit_data(id)
    {
        ...
        //Load data from ajax
        $.ajax({
            url : "<?php echo site_url('Login/account_edit/')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('.modal-title').text('Perbarui Data User'); // Set title to Bootstrap modal title
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('Login/account_add')?>";
        }
        else if(save_method == 'update'){
            url = "<?php echo site_url('Login/account_update')?>"; 
        }
